    ...
    for line in commands:
        if line != '':
            ...
            if line.startswith('R') or line.startswith('SW'):
                subline = line.split()
                subdevice = subline[0]
                main_interface = subline[1] + subline[2]
                subinterface = subline[-2] + subline[-1]
                neighbors[(main_device, main_interface)] = (subdevice, subinterface)
