...
def check_password(password):
    ...
    has_lowercase = False
    has_digit = False
    if len(password) > 7 and len(password) < 129:
        ...
        return False
    return all([has_uppercase, has_lowercase, has_digit])
...
def create_user():
    ...
    if wrong_params:
        ...
        return render_template('users_new.html', user = params, roles_list = load_roles(), wrong_params = wrong_params)
